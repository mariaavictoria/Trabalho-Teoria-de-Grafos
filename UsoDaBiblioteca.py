...
#3. Utilize as funções disponíveis na classe Grafo
Objeto_Teste.BFS(1) #Caso queira realizar uma busca em largura no grafo (Ex: vértice raiz 1)
Objeto_Teste.DFS(1) #Caso queira realizar uma busca em profundidade no grafo (Ex: vértice raiz 1)
Objeto_Teste.distancia(1, 5) #Caso queira calcular a distância entre dois vértices (Ex: 1 e 5)
Objeto_Teste.diametro() #Caso queira calcular o diâmetro do grafo
Objeto_Teste.ComponentesConexas() #Caso queira determinar as componentes conexas do grafo
Objeto_Teste.DiametroAprox() #Caso queira calcular uma aproximação do diâmetro do grafo
Objeto_Teste.CriarTxt() #Caso queira criar um arquivo texto com informações do grafo