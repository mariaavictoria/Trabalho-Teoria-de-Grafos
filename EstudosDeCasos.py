...
#Estudo de Caso 3 (Executar 100 vezes a Busca em Profundidade e calcular a média do tempo de execução)
Objeto_Teste.DFS(1) #Ex: Busca em Profundidade no grafo com raiz no vértice 1

#Estudo de Caso 4 (Analisar arquivos textos, InfoBFS e InfoDFS, para determinar os pais dos vértices 10, 20 e 30)
Objeto_Teste.BFS(1) #Busca em Largura com raiz no vértice 1
Objeto_Teste.BFS(2) #Busca em Largura com raiz no vértice 2
Objeto_Teste.BFS(3) #Busca em Largura com raiz no vértice 3
Objeto_Teste.DFS(1) #Busca em Profundidade com raiz no vértice 1
Objeto_Teste.DFS(2) #Busca em Profundidade com raiz no vértice 2
Objeto_Teste.DFS(3) #Busca em Profundidade com raiz no vértice 3

#Estudo de Caso 5 (Determinar a distância entre os pares: (10, 20), (10, 30), (20, 30))
Objeto_Teste.distancia(10, 20)
Objeto_Teste.distancia(10, 30)
Objeto_Teste.distancia(20, 30)

#Estudo de Caso 6 (Analisar arquivo texto, Info, para determinar a quantidade de componentes conexas)
#(No mesmo arquivo, também é possível encontrar a maior, a menor e seus respectivos tamanhos)
#(Essa informação também pode ser obtida pela chamada do próprio método .ComponentesConexas())
Objeto_Teste.CriarTxt()
Objeto_Teste.ComponentesConexas()

#Estudo de Caso 7 (Determinar o diâmetro do grafo com os métodos .diametro() e .DiametroAprox())
#(O método .DiametroAprox() tornou-se necessário em virtude da dimensão dos grafos)
Objeto_Teste.diametro() #Cálculo do valor real
Objeto_Teste.DiametroAprox() #Aproximação do valor
